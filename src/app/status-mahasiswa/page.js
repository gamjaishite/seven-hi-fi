                  ...
                  <div className="w-4/5 pt-5 pb-7 text-left h-full text-[15px]">
                        <ul className="list-disc">
                          <li className="underline-offset-2">
                            <a href="/jadwal" className="underline-offset-2 hover:--seven-hyperlink">Jadwal Perkuliahan</a>
                          </li>
                          <li className="underline-offset-2">
            ...
            <div className="flex flex-col lg:flex-row gap-2">
              <div className="border rounded bg-[#f9f9f9] rounded-[5px] w-full border-[#3277B2] h-fit">
                ...
                <div className="div-auto flex flex-col bg-[#f9f9f9] w-full rounded-[5px] border-[#3277B2]">
                  ...
                  <div className="text-[13px] py-[2px] flex w-full bg-white border min-w-[300px]">
